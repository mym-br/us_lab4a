...
for elem in range(NUM_ELEMENTS):
    for n in range(KV_OVERSAMP_FACTOR):
        signals_os[elem * KV_OVERSAMP_FACTOR + n, :signal_len] = signals[elem, :]
...
kv_period = two_pi / (PITCH / KV_OVERSAMP_FACTOR)
