...
template<typename TFloat, typename ImpulseResponse>
void
SimTransientAcousticField<TFloat, ImpulseResponse>::getCircularSourceAcousticField(
					TFloat samplingFreq,
					TFloat propagationSpeed,
					TFloat sourceRadius,
					TFloat discretization,
...
template<typename TFloat, typename ImpulseResponse>
void
SimTransientAcousticField<TFloat, ImpulseResponse>::getCircularSourceAcousticFieldSingleThread(
					TFloat samplingFreq,
					TFloat propagationSpeed,
					TFloat sourceRadius,
					TFloat discretization,
...
template<typename TFloat, typename ImpulseResponse>
void
SimTransientAcousticField<TFloat, ImpulseResponse>::getRectangularSourceAcousticField(
					TFloat samplingFreq,
					TFloat propagationSpeed,
					TFloat sourceWidth,
					TFloat sourceHeight,
...
template<typename TFloat, typename ImpulseResponse>
void
SimTransientAcousticField<TFloat, ImpulseResponse>::getRectangularSourceAcousticFieldSingleThread(
					TFloat samplingFreq,
					TFloat propagationSpeed,
					TFloat sourceWidth,
					TFloat sourceHeight,
...
template<typename TFloat, typename ImpulseResponse>
void
SimTransientAcousticField<TFloat, ImpulseResponse>::getArrayOfRectangularSourcesAcousticField(
					TFloat samplingFreq,
					TFloat propagationSpeed,
					TFloat sourceWidth,
					TFloat sourceHeight,
...
template<typename TFloat, typename ImpulseResponse>
void
SimTransientAcousticField<TFloat, ImpulseResponse>::getArrayOfRectangularSourcesAcousticFieldSingleThread(
					TFloat samplingFreq,
					TFloat propagationSpeed,
					TFloat sourceWidth,
					TFloat sourceHeight,
