...
METHOD_ITEM(CylinderDetectionAndFermatMethod<double>, cylinder_detection_and_fermat_two_medium_imaging_combined_cyl_wave_2_dp) \
METHOD_ITEM(CylinderDetectionAndFermatMethod<double>, cylinder_detection_and_fermat_two_medium_imaging_combined_cyl_wave_3_dp) \
METHOD_ITEM(CylinderDetectionAndFermatMethod<double>, cylinder_detection_and_fermat_two_medium_imaging_combined_sta_dp) \
METHOD_ITEM(CylinderDetectionAndFermatMethod<double>, cylinder_detection_and_fermat_two_medium_imaging_combined_sta_2_dp) \
METHOD_ITEM(CylinderDetectionAndFermatMethod<double>, cylinder_detection_and_fermat_two_medium_imaging_combined_sta_3_dp) \
