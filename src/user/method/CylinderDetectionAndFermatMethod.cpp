...
template class CylinderDetectionAndFermatMethod<float>;
template class CylinderDetectionAndFermatMethod<double>;
#ifdef LAB_ENABLE_OPENCL
template void CylinderDetectionAndFermatMethod<float>::execCombinedTwoMediumImagingCyl<VectorialCombinedTwoMediumImagingOCLProcessor<float>>();
template void CylinderDetectionAndFermatMethod<double>::execCombinedTwoMediumImagingCyl<VectorialCombinedTwoMediumImagingOCLProcessor<double>>();
template void CylinderDetectionAndFermatMethod<float>::execCombinedTwoMediumImagingCyl<VectorialCombinedTwoMediumImagingOCLProcessor2<float>>();
template void CylinderDetectionAndFermatMethod<double>::execCombinedTwoMediumImagingCyl<VectorialCombinedTwoMediumImagingOCLProcessor2<double>>();
#endif
#ifdef LAB_ENABLE_CUDA
template void CylinderDetectionAndFermatMethod<float>::execCombinedTwoMediumImagingCyl<VectorialCombinedTwoMediumImagingCUDAProcessor>();
template void CylinderDetectionAndFermatMethod<float>::execCombinedTwoMediumImagingCyl<VectorialCombinedTwoMediumImagingCUDAProcessor2>();
#endif
