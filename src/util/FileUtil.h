...
std::string signalsPath(const std::string& baseDir, unsigned int baseElement);
std::string txElemSignalsPath(const std::string& baseDir, unsigned int baseElement, unsigned int txElem);
